...
@Generated(
    ...
    date = "2022-12-06T09:14:40.771921+02:00",
...
public class BloodPressureAnyEventIntervalEvent implements IntervalEventEntity, BloodPressureAnyEventChoice {
  ...
  /**
   * Path: petetest/Blood pressure/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: petetest/Blood pressure/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: petetest/Blood pressure/Any event/sample_count
   */
  @Path("/sample_count")
